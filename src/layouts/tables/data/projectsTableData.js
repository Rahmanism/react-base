...
export default function data() {
  ...
  return {
    columns: [
      { id: 'project', Header: 'project', accessor: 'project', width: '30%', align: 'left' },
      { id: 'budget', Header: 'budget', accessor: 'budget', align: 'left' },
      { id: 'status', Header: 'status', accessor: 'status', align: 'center' },
      { id: 'completion', Header: 'completion', accessor: 'completion', align: 'center' },
